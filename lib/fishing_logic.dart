...
final Map<String, Map<String, double>> baitAffinity = {
  ...
  '민물새우': {'붕어': 1.5, '잉어': 1.0, '가물치': 1.0, '떡붕어': 1.5, '블루길': 1.5, '살치': 0.0, '베스': 0.5, '강준치': 1.0, '자라': 0.5, '메기': 1.5, '쏘가리': 0.1, '꺽지': 0.1, '무지개송어': 0.1, '향어': 0.5, '민물장어': 1.5, '동자개': 2.0, '누치': 1.5, '끄리': 1.0, '초어': 0.0, '모래무지': 1.5},
  // ── 루어 미끼(민물) ──
