...
final Map<String, Map<String, double>> baitAffinity = {
  // ── 민물 ──
  '글루텐':   {'붕어': 2.0, '떡붕어': 2.0, '블루길': 0.2, '살치': 1.0, '베스': 0.2, '강준치': 1.5, '잉어': 1.5, '자라': 0.3, '메기': 0.2, '가물치': 0.3},
  '지렁이':   {'붕어': 1.0, '떡붕어': 1.0, '블루길': 2.0, '살치': 1.5, '베스': 2.0, '강준치': 1.0, '잉어': 1.0, '자라': 1.0, '메기': 2.0, '가물치': 2.0},
  '옥수수':   {'붕어': 1.5, '떡붕어': 1.5, '블루길': 0.2, '살치': 1.0, '베스': 0.2, '강준치': 2.0, '잉어': 2.0, '자라': 1.0, '메기': 0.2, '가물치': 0.5},
  '민물새우': {'붕어': 1.8, '떡붕어': 1.2, '블루길': 1.5, '살치': 0.5, '베스': 1.8, '강준치': 0.5, '잉어': 1.5, '자라': 0.5, '메기': 1.8, '가물치': 1.8}, // 🦐 생새우 = 육식·대물에 강함
  // ── 바다 ──
  '갯지렁이': {'고등어': 1.0, '우럭': 1.5, '갈치': 1.0, '참돔': 1.5, '광어': 1.5, '감성돔': 1.5, '갑오징어': 0.2, '주꾸미': 0.2, '문어': 0.2, '벵에돔': 1.0, '참치': 0.5},
  '크릴':     {'고등어': 2.0, '우럭': 1.5, '갈치': 2.0, '참돔': 2.0, '광어': 1.0, '감성돔': 2.0, '갑오징어': 0.2, '주꾸미': 0.2, '문어': 0.2, '벵에돔': 2.0, '참치': 0.5},
  '루어':     {'고등어': 1.0, '우럭': 2.0, '갈치': 1.5, '참돔': 1.5, '광어': 2.0, '감성돔': 1.0, '갑오징어': 0.2, '주꾸미': 0.2, '문어': 0.2, '벵에돔': 1.5, '참치': 0.5},
  '에기':     {'고등어': 0.3, '우럭': 0.3, '갈치': 0.3, '참돔': 0.3, '광어': 0.3, '감성돔': 0.3, '갑오징어': 2.0, '주꾸미': 2.0, '문어': 2.0, '벵에돔': 0.3, '참치': 0.3},
  // 🐟 특수 미끼: 잡은 고등어를 미끼로 쓰면 참치가 매우 잘 물림(생미끼)
  '고등어':   {'참치': 2.0},
};
