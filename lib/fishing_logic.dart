...
class FishingLogic {
  ...
  static final Map<String, List<String>> locationFishMap = {
    ...
    '예산 예당지': ['붕어', '떡붕어', '블루길', '베스', '살치', '잉어', '메기', '자라', '가물치', '강준치', '쏘가리', '꺽지', '무지개송어', '향어', '민물장어', '동자개', '모래무지', '누치', '끄리', '초어'],
    '안성 고삼지': ['붕어', '떡붕어', '블루길', '베스', '살치', '잉어', '메기', '자라', '가물치', '강준치', '쏘가리', '꺽지', '무지개송어', '향어', '민물장어', '동자개', '모래무지', '누치', '끄리', '초어'],
    '진천 백곡지': ['붕어', '떡붕어', '블루길', '베스', '살치', '잉어', '메기', '자라', '가물치', '강준치', '쏘가리', '꺽지', '무지개송어', '향어', '민물장어', '동자개', '모래무지', '누치', '끄리', '초어'],
    '춘천 파로호': ['붕어', '떡붕어', '블루길', '베스', '살치', '잉어', '메기', '자라', '가물치', '강준치', '쏘가리', '꺽지', '무지개송어', '향어', '민물장어', '동자개', '모래무지', '초어', '누치', '끄리'],
    '충주 충주호': ['붕어', '떡붕어', '블루길', '베스', '살치', '잉어', '메기', '자라', '가물치', '강준치', '쏘가리', '꺽지', '무지개송어', '향어', '민물장어', '동자개', '모래무지', '초어', '누치', '끄리'],
    '예산 신양수로': ['붕어', '떡붕어', '블루길', '베스', '살치', '잉어', '메기', '자라', '가물치', '강준치', '쏘가리', '꺽지', '무지개송어', '향어', '민물장어', '동자개', '모래무지', '누치', '끄리', '초어'],
    '청양 지천': ['붕어', '떡붕어', '블루길', '베스', '살치', '잉어', '메기', '자라', '가물치', '강준치', '쏘가리', '꺽지', '무지개송어', '향어', '민물장어', '동자개', '모래무지', '누치', '끄리', '초어'],
    '인천 청라수로': ['붕어', '떡붕어', '블루길', '베스', '살치', '잉어', '메기', '자라', '가물치', '강준치', '쏘가리', '꺽지', '무지개송어', '향어', '민물장어', '동자개', '모래무지', '누치', '끄리', '초어'],
    '해남 금자천': ['붕어', '떡붕어', '블루길', '베스', '살치', '잉어', '메기', '자라', '가물치', '강준치', '쏘가리', '꺽지', '무지개송어', '향어', '민물장어', '동자개', '모래무지', '누치', '끄리', '초어'],
    '충주 달천': ['붕어', '떡붕어', '블루길', '베스', '살치', '잉어', '메기', '자라', '가물치', '강준치', '쏘가리', '꺽지', '무지개송어', '향어', '민물장어', '동자개', '모래무지', '누치', '끄리', '초어'],

    // 🌊 [바다] 갯바위 & 선상 (바다고기 11종 총출동!)
    '통영 척포 갯바위': ['고등어', '우럭', '갈치', '참돔', '광어', '감성돔', '갑오징어', '주꾸미', '문어', '벵에돔', '참치', '볼락', '학꽁치', '성대', '농어', '부시리', '돌돔', '방어', '쥐노래미', '무늬오징어'],
    '신안 가거도': ['고등어', '우럭', '갈치', '참돔', '광어', '감성돔', '갑오징어', '주꾸미', '문어', '벵에돔', '참치', '볼락', '학꽁치', '성대', '농어', '부시리', '돌돔', '방어', '쥐노래미', '무늬오징어'],
    '완도 청산도': ['고등어', '우럭', '갈치', '참돔', '광어', '감성돔', '갑오징어', '주꾸미', '문어', '벵에돔', '참치', '볼락', '학꽁치', '성대', '농어', '부시리', '돌돔', '방어', '쥐노래미', '무늬오징어'],
    '여수 거문도': ['고등어', '우럭', '갈치', '참돔', '광어', '감성돔', '갑오징어', '주꾸미', '문어', '벵에돔', '참치', '볼락', '학꽁치', '성대', '농어', '부시리', '돌돔', '방어', '쥐노래미', '무늬오징어'],
    '제주 섶섬': ['고등어', '우럭', '갈치', '참돔', '광어', '감성돔', '갑오징어', '주꾸미', '문어', '벵에돔', '참치', '볼락', '학꽁치', '성대', '농어', '부시리', '돌돔', '방어', '쥐노래미', '무늬오징어'],
    '거제 선상': ['고등어', '우럭', '갈치', '참돔', '광어', '감성돔', '갑오징어', '주꾸미', '문어', '벵에돔', '참치', '볼락', '학꽁치', '성대', '농어', '부시리', '돌돔', '방어', '쥐노래미', '무늬오징어'],
    '오천항 선상': ['고등어', '우럭', '갈치', '참돔', '광어', '감성돔', '갑오징어', '주꾸미', '문어', '벵에돔', '참치', '볼락', '학꽁치', '성대', '농어', '부시리', '돌돔', '방어', '쥐노래미', '무늬오징어'],
    '대천 선상': ['고등어', '우럭', '갈치', '참돔', '광어', '감성돔', '갑오징어', '주꾸미', '문어', '벵에돔', '참치', '볼락', '학꽁치', '성대', '농어', '부시리', '돌돔', '방어', '쥐노래미', '무늬오징어'],
    '통영 선상': ['고등어', '우럭', '갈치', '참돔', '광어', '감성돔', '갑오징어', '주꾸미', '문어', '벵에돔', '참치', '볼락', '학꽁치', '성대', '농어', '부시리', '돌돔', '방어', '쥐노래미', '무늬오징어'],
    '완도 선상': ['고등어', '우럭', '갈치', '참돔', '광어', '감성돔', '갑오징어', '주꾸미', '문어', '벵에돔', '참치', '볼락', '학꽁치', '성대', '농어', '부시리', '돌돔', '방어', '쥐노래미', '무늬오징어'],
  };
...
final Map<String, Map<String, double>> baitAffinity = {
  ...
  // 🐟 [2026-09-02] 누치·끄리·초어·모래무지 4종 추가. 정답 미끼를 서로 다르게 뒀다 —
  //    누치·모래무지=지렁이(바닥 먹이), 초어=옥수수(초식성이라 지렁이엔 안 온다),
  //    끄리=루어(육식). 미끼를 바꿔 들 이유를 만든다.
  '글루텐':   {'붕어': 2.0, '잉어': 1.5, '가물치': 0.0, '떡붕어': 2.0, '블루길': 0.0, '살치': 1.0, '베스': 0.0, '강준치': 0.0, '자라': 0.2, '메기': 0.0, '쏘가리': 0.0, '꺽지': 0.0, '무지개송어': 0.0, '향어': 2.0, '민물장어': 0.0, '동자개': 0.0, '누치': 1.0, '끄리': 0.0, '초어': 1.5, '모래무지': 0.5},
  '지렁이':   {'붕어': 1.5, '잉어': 1.0, '가물치': 1.0, '떡붕어': 1.0, '블루길': 2.0, '살치': 1.0, '베스': 0.5, '강준치': 1.5, '자라': 0.5, '메기': 2.0, '쏘가리': 0.1, '꺽지': 0.1, '무지개송어': 0.1, '향어': 0.5, '민물장어': 2.0, '동자개': 1.5, '누치': 2.0, '끄리': 1.0, '초어': 0.2, '모래무지': 2.0},
  '옥수수':   {'붕어': 1.5, '잉어': 2.0, '가물치': 0.0, '떡붕어': 1.0, '블루길': 0.0, '살치': 1.5, '베스': 0.0, '강준치': 0.0, '자라': 0.0, '메기': 0.0, '쏘가리': 0.0, '꺽지': 0.0, '무지개송어': 0.0, '향어': 1.0, '민물장어': 0.0, '동자개': 0.0, '누치': 0.5, '끄리': 0.0, '초어': 2.0, '모래무지': 0.2},
  // 🦐 채집망으로 공짜로 모이는 미끼 — 어떤 어종도 상점 미끼보다 잘 물리지 않게 낮췄다(2026-09-10).
  //    표에서 빼면 매칭이 안 돼 전 어종 1.0 이 되어 오히려 강해진다. 반드시 값으로 낮춘다.
  '민물새우': {'붕어': 0.5, '잉어': 0.5, '가물치': 0.5, '떡붕어': 0.5, '블루길': 0.5, '살치': 0.0, '베스': 0.3, '강준치': 0.5, '자라': 0.3, '메기': 0.5, '쏘가리': 0.1, '꺽지': 0.1, '무지개송어': 0.1, '향어': 0.3, '민물장어': 0.5, '동자개': 1.0, '누치': 0.5, '끄리': 0.5, '초어': 0.0, '모래무지': 0.5},
  // ── 루어 미끼(민물) ──
  '스푼':     {'붕어': 0.0, '잉어': 0.0, '가물치': 2.0, '떡붕어': 0.0, '블루길': 0.0, '살치': 0.0, '베스': 2.0, '강준치': 2.0, '자라': 0.0, '메기': 0.0, '쏘가리': 1.0, '꺽지': 0.0, '무지개송어': 1.5, '향어': 0.0, '민물장어': 0.0, '동자개': 0.0, '누치': 0.0, '끄리': 2.0, '초어': 0.0, '모래무지': 0.0},
  '플라이':   {'붕어': 0.0, '잉어': 0.0, '가물치': 0.5, '떡붕어': 0.0, '블루길': 0.0, '살치': 0.0, '베스': 0.2, '강준치': 0.5, '자라': 0.0, '메기': 0.0, '쏘가리': 0.2, '꺽지': 2.0, '무지개송어': 0.5, '향어': 0.0, '민물장어': 0.0, '동자개': 0.0, '누치': 0.2, '끄리': 1.5, '초어': 0.0, '모래무지': 0.0},
  // ── 웜(민물·바다 공용) — 두 영역 어종 모두 포함 ──
  '웜': {
    '붕어': 0.0, '잉어': 0.0, '가물치': 1.0, '떡붕어': 0.0, '블루길': 0.0, '살치': 0.0, '베스': 1.5, '강준치': 1.0, '자라': 0.0, '메기': 0.0, '쏘가리': 2.0, '꺽지': 1.0, '무지개송어': 2.0, '향어': 0.0, '민물장어': 0.0, '동자개': 0.0, '누치': 0.1, '끄리': 1.5, '초어': 0.0, '모래무지': 0.0,
    '참돔': 0.1, '감성돔': 0.1, '문어': 0.5, '고등어': 0.0, '우럭': 0.0, '갈치': 1.0, '광어': 2.0, '갑오징어': 1.0, '주꾸미': 0.5, '벵에돔': 0.5, '볼락': 1.0, '학꽁치': 0.0, '참치': 0.0, '성대': 1.0, '농어': 0.0, '부시리': 1.0, '돌돔': 0.0, '방어': 0.5, '쥐노래미': 1.5, '무늬오징어': 0.0,
  },
  // ── 바다 미끼 ── (2026-08-16 성대/농어/부시리/돌돔 4종 추가)
  '갯지렁이': {'참돔': 1.5, '감성돔': 0.5, '문어': 0.0, '고등어': 0.0, '우럭': 2.0, '갈치': 0.5, '광어': 1.0, '갑오징어': 0.0, '주꾸미': 0.0, '벵에돔': 0.0, '볼락': 2.0, '학꽁치': 1.0, '참치': 0.0, '성대': 2.0, '농어': 1.5, '부시리': 0.0, '돌돔': 1.5, '방어': 0.3, '쥐노래미': 2.0, '무늬오징어': 0.0},
  '크릴':     {'참돔': 2.0, '감성돔': 2.0, '문어': 0.0, '고등어': 2.0, '우럭': 0.5, '갈치': 1.0, '광어': 1.0, '갑오징어': 0.0, '주꾸미': 0.0, '벵에돔': 2.0, '볼락': 1.0, '학꽁치': 2.0, '참치': 0.0, '성대': 1.0, '농어': 1.0, '부시리': 0.0, '돌돔': 1.0, '방어': 0.5, '쥐노래미': 1.0, '무늬오징어': 0.0},
  '루어':     {'참돔': 0.5, '감성돔': 1.0, '문어': 0.5, '고등어': 1.0, '우럭': 1.0, '갈치': 2.0, '광어': 0.5, '갑오징어': 1.0, '주꾸미': 0.5, '벵에돔': 1.5, '볼락': 0.5, '학꽁치': 0.0, '참치': 1.0, '성대': 0.5, '농어': 2.0, '부시리': 1.5, '돌돔': 0.0, '방어': 1.5, '쥐노래미': 0.5, '무늬오징어': 0.5},
  '에기':     {'참돔': 0.0, '감성돔': 0.0, '문어': 2.0, '고등어': 0.0, '우럭': 0.0, '갈치': 0.0, '광어': 0.0, '갑오징어': 2.0, '주꾸미': 2.0, '벵에돔': 0.0, '볼락': 0.0, '학꽁치': 0.0, '참치': 0.0, '성대': 0.0, '농어': 0.0, '부시리': 0.0, '돌돔': 0.0, '방어': 0.0, '쥐노래미': 0.0, '무늬오징어': 2.0},
  // 🐟 특수 미끼: 잡은 고등어를 미끼로 쓰면 참치·부시리가 잘 물림(생미끼)
  // ── 생미끼(잡은 물고기를 미끼로) — 민물새우처럼 어종별 확률을 전부 채운다 ──
  //   ⚠️ 예전엔 고등어에 참치·부시리·방어 셋만 적어둬서, 표에 없는 어종이 전부
  //      1.0(보통)으로 처리됐다 → 40cm 고등어에 20cm 학꽁치가 물었다(2026-09-05 제보).
  //      빠진 어종이 곧 '보통'이 되므로 생미끼는 20종을 다 적어야 한다.
  //   🐟🦑 생미끼(잡은 고기를 미끼로) — "대물 전용"으로 좁혀 둔다.
  //   ⚠️ 폭을 넓히면 상점 미끼가 안 팔린다. 잡아서 쓰는 미끼로 대부분 어종이 나오면
  //      갯지렁이·크릴·루어를 살 이유가 사라진다(2026-09-05 사용자 지적).
  //      그래서 일반 어종은 전부 0.0. 생미끼는 갯지렁이·크릴로는 안 되는
  //      참치·부시리·방어를 노릴 때만 쓰는 물건이다.
  //   🐟 고등어 = 회유성 대물. 방어에 가장 강하다.
  '고등어 미끼조각': {'참돔': 0.3, '감성돔': 0.0, '문어': 0.5, '고등어': 0.0, '우럭': 1.2, '갈치': 2.0, '광어': 1.5, '갑오징어': 0.0, '주꾸미': 0.0, '벵에돔': 0.0, '볼락': 0.5, '학꽁치': 0.0, '참치': 1.0, '성대': 0.6, '농어': 1.0, '부시리': 1.5, '돌돔': 0.0, '방어': 2.0, '쥐노래미': 0.5, '무늬오징어': 0.0},
  //   🦑 무늬오징어 = 문어·갈치·참돔에 강하다. 에기로만 잡히는 걸 미끼로 쓸지가 고민.
  '오징어 미끼조각': {'참돔': 1.5, '감성돔': 0.4, '문어': 1.5, '고등어': 0.0, '우럭': 1.0, '갈치': 1.5, '광어': 0.8, '갑오징어': 0.0, '주꾸미': 0.0, '벵에돔': 0.0, '볼락': 1.2, '학꽁치': 0.0, '참치': 1.0, '성대': 0.5, '농어': 1.5, '부시리': 1.5, '돌돔': 0.0, '방어': 1.2, '쥐노래미': 0.6, '무늬오징어': 0.0},
};
...
for (var fish in availableFishes) {
  ...
  /// 🆓 돈을 내지 않고 얻는 미끼 — 감도 보너스를 주지 않는다.
  ///   공짜 미끼가 상점 미끼보다 좋으면 미끼를 살 이유가 없어진다.
  static const List<String> kFreeBaits = [
    '민물새우', '고등어 미끼조각', '오징어 미끼조각',
  ];

  // 🪱 미끼 이름 → 감도(S) 보너스. stats 필드 없는 옛 미끼·민물새우도 착용 시 감도 적용되게.
  static int baitSensByName(String name) {
    // 🦐 민물새우는 채집망으로 공짜로 모이는 미끼다 — 감도 보너스를 주지 않는다.
    //    예전엔 지렁이(2,000원)와 같은 +20 이 '보이지 않는 값'으로 붙어서,
    //    돈 주고 사는 미끼를 쓸 이유가 없었다(2026-09-10).
    if (['지렁이', '갯지렁이', '에기'].contains(name)) return 20;
  ...
  static Map<String, int> getMyTotalStats({
    ...
    if (equippedBait != null) {
      final String bn = (equippedBait['name'] ?? '').toString();
      // 🦐 공짜로 얻는 미끼(채집망 새우 · 잡은 고기를 자른 조각)는 감도 보너스가 없다.
      //    이미 가방에 있는 것도 같이 적용되도록 stats 보다 먼저 걸러낸다(2026-09-10).
      if (!kFreeBaits.contains(bn)) {
        final bs = equippedBait['stats'];
        final byStat = (bs is Map && bs['S'] != null) ? (int.tryParse(bs['S'].toString()) ?? 0) : 0;
        totalSens += byStat > 0 ? byStat : baitSensByName(bn);
      }
    }
