...
class FishingLogic {
  ...
  static final Map<String, List<String>> locationFishMap = {
    ...
    '예산 예당지': ['붕어', '떡붕어', '블루길', '베스', '살치', '잉어', '메기', '자라', '가물치', '강준치', '쏘가리', '꺽지', '무지개송어', '향어', '민물장어', '동자개', '모래무지'],
    '안성 고삼지': ['붕어', '떡붕어', '블루길', '베스', '살치', '잉어', '메기', '자라', '가물치', '강준치', '쏘가리', '꺽지', '무지개송어', '향어', '민물장어', '동자개', '모래무지'],
    '진천 백곡지': ['붕어', '떡붕어', '블루길', '베스', '살치', '잉어', '메기', '자라', '가물치', '강준치', '쏘가리', '꺽지', '무지개송어', '향어', '민물장어', '동자개', '모래무지'],
    '춘천 파로호': ['붕어', '떡붕어', '블루길', '베스', '살치', '잉어', '메기', '자라', '가물치', '강준치', '쏘가리', '꺽지', '무지개송어', '향어', '민물장어', '동자개', '모래무지', '초어'],
    '충주 충주호': ['붕어', '떡붕어', '블루길', '베스', '살치', '잉어', '메기', '자라', '가물치', '강준치', '쏘가리', '꺽지', '무지개송어', '향어', '민물장어', '동자개', '모래무지', '초어'],
    '예산 신양수로': ['붕어', '떡붕어', '블루길', '베스', '살치', '잉어', '메기', '자라', '가물치', '강준치', '쏘가리', '꺽지', '무지개송어', '향어', '민물장어', '동자개', '모래무지', '누치', '끄리'],
    '청양 지천': ['붕어', '떡붕어', '블루길', '베스', '살치', '잉어', '메기', '자라', '가물치', '강준치', '쏘가리', '꺽지', '무지개송어', '향어', '민물장어', '동자개', '모래무지', '누치', '끄리'],
    '인천 청라수로': ['붕어', '떡붕어', '블루길', '베스', '살치', '잉어', '메기', '자라', '가물치', '강준치', '쏘가리', '꺽지', '무지개송어', '향어', '민물장어', '동자개', '모래무지', '누치', '끄리'],
    '해남 금자천': ['붕어', '떡붕어', '블루길', '베스', '살치', '잉어', '메기', '자라', '가물치', '강준치', '쏘가리', '꺽지', '무지개송어', '향어', '민물장어', '동자개', '모래무지', '누치', '끄리'],
    '충주 달천': ['붕어', '떡붕어', '블루길', '베스', '살치', '잉어', '메기', '자라', '가물치', '강준치', '쏘가리', '꺽지', '무지개송어', '향어', '민물장어', '동자개', '모래무지', '누치', '끄리'],
