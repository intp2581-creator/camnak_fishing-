...
final Map<String, Map<String, double>> baitAffinity = {
  ...
  '에기':     {'참돔': 0.0, '감성돔': 0.0, '문어': 2.0, '고등어': 0.0, '우럭': 0.0, '갈치': 0.0, '광어': 0.0, '갑오징어': 2.0, '주꾸미': 2.0, '벵에돔': 0.0, '볼락': 0.0, '학꽁치': 0.0, '참치': 0.0, '성대': 0.0, '농어': 0.0, '부시리': 0.0, '돌돔': 0.0, '방어': 0.0, '쥐노래미': 0.0, '무늬오징어': 2.5},
  // 🐟 특수 미끼: 잡은 고등어를 미끼로 쓰면 참치·부시리가 잘 물림(생미끼)
  '고등어':   {'참치': 1.5, '부시리': 1.5, '방어': 2.0},   // 🐟 방어도 생미끼에 반응
};
