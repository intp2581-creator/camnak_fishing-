...
const Map<String, Map<String, double>> spotTypeAffinity = {
  // 🏞️ 저수지: 토종 붕어·잉어·떡붕어 위주 (외래종은 약간 적게)
  '저수지': {'붕어': 1.4, '떡붕어': 1.4, '잉어': 1.4, '가물치': 1.2, '메기': 1.2, '베스': 0.8, '블루길': 0.8},
  // 🌊 수로: 외래종(배스·블루길)·잡어(강준치·살치) 많음
  '수로': {'베스': 1.5, '블루길': 1.5, '강준치': 1.3, '살치': 1.3, '메기': 1.2, '잉어': 0.9},
  // 🪨 갯바위: 돔류·록피시 (감성돔·벵에돔·참돔·우럭)
  '갯바위': {'감성돔': 1.5, '벵에돔': 1.5, '참돔': 1.3, '우럭': 1.3, '갈치': 0.7, '고등어': 0.7, '광어': 0.8},
  // 🚢 선상: 회유어·바닥고기·두족류 (갈치·고등어·광어·우럭·주꾸미·갑오징어·문어·참치)
  '선상': {'갈치': 1.5, '고등어': 1.4, '광어': 1.4, '우럭': 1.2, '주꾸미': 1.3, '갑오징어': 1.3, '문어': 1.3, '참치': 1.2, '감성돔': 0.7, '벵에돔': 0.7},
};
