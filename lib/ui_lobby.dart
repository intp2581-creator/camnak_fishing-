                ...
                child: StreamBuilder<DocumentSnapshot>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    if (snapshot.hasData && snapshot.data!.data() != null) {
                      ...
                      if (realLevel >= 30) {
                        charImgPath = 'assets/images/char_master.png';
                      } else if (realLevel >= 5) {
                        charImgPath = 'assets/images/char_novice.png'; 
                      } else {
