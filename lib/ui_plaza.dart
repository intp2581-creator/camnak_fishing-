...
class _PlazaScreenState extends State<PlazaScreen> with SingleTickerProviderStateMixin {
                  ...
                  children: [
                        ...
                        ...(() {
                          ...
                          if (!widget.isSea) {
                            ...
                            sprites.add(MapEntry(0.520, _plazaPortal(worldW, worldH, sizeRef, 0.500, 0.520, kCenterpieceFile, kCenterpieceHFrac)));
                            sprites.add(MapEntry(0.700, _plazaPortal(worldW, worldH, sizeRef, 0.270, 0.700, 'portal_rank_fw.png', 0.42)));
                            sprites.add(MapEntry(0.380, _plazaPortal(worldW, worldH, sizeRef, 0.130, 0.380, 'portal_guild_fw.png', 0.40)));
                            sprites.add(MapEntry(0.310, _plazaPortal(worldW, worldH, sizeRef, 0.350, 0.310, 'portal_fishing_fw.png', 0.40)));
                            sprites.add(MapEntry(0.310, _plazaPortal(worldW, worldH, sizeRef, 0.660, 0.310, 'portal_arena_fw.png', 0.42)));
                            sprites.add(MapEntry(0.45, _plazaPortal(worldW, worldH, sizeRef, 0.870, 0.450, 'portal_shop_fw.png', 0.48)));
                            sprites.add(MapEntry(0.720, _plazaPortal(worldW, worldH, sizeRef, 0.720, 0.720, 'portal_quest_fw.png', 0.36)));
                          }
                          // 🧍 내 캐릭터 (탭 통과)
                        ...
                        _standNpc(worldW, worldH, sizeRef, widget.isSea ? 0.270 : 0.146,
                            widget.isSea ? 0.700 : 0.662, 'npc_rank.png', 'gm_garam.png', '가람', '🏆 랭킹',
                            _onGaramTap,
                            scale: 0.9),
                        _standNpc(worldW, worldH, sizeRef, widget.isSea ? 0.130 : 0.294,
                            widget.isSea ? 0.380 : 0.424, 'npc_guild.png', 'npc_manager_congrats.png', '윤슬', '🛡️ 길드',
                            () => _openNpcIntro('npc_guild.png', 'guild', '길드 보기', _openGuild),
                            scale: 0.85),
                        _standNpc(worldW, worldH, sizeRef, widget.isSea ? 0.350 : 0.500,
                            widget.isSea ? 0.310 : 0.270, 'npc_fishing.png', 'npc_girl_intro.png', '나루', '🌀 낚시터',
                            () => _openNpcIntro('npc_fishing.png', 'fishing', '낚시터 이동', _openMinimap),
                            scale: 0.9),
                        _standNpc(worldW, worldH, sizeRef, widget.isSea ? 0.660 : 0.725,
                            widget.isSea ? 0.310 : 0.391, 'npc_arena.png', 'npc_girl_point.png', '한별', '⚔️ 아레나',
                            _onHanbyeolTap,
                            scale: 0.82),
                        _standNpc(worldW, worldH, sizeRef, widget.isSea ? 0.870 : 0.910,
                            widget.isSea ? 0.450 : 0.630, 'npc_shop.png', 'npc_manager.png', '서윤', '🏪 상점',
  ...
  Widget _araNpc(double worldW, double worldH, double sizeH) {
    final cx = widget.isSea ? 0.720 : 0.513;
    final cy = widget.isSea ? 0.720 : 0.920; // 발 위치 (민물 / 바다=새 배치)
    // 🧍 원근 크기(아주 약하게)
