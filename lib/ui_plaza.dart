...
class _PlazaScreenState extends State<PlazaScreen> with SingleTickerProviderStateMixin {
                  ...
                  children: [
                        ...
                        ...(() {
                          ...
                          if (!widget.isSea) {
                            ...
                            sprites.add(MapEntry(0.370, _plazaPortal(worldW, worldH, sizeRef, 0.680, 0.370, 'portal_arena_fw.png', 0.30)));
                            sprites.add(MapEntry(0.680, _plazaPortal(worldW, worldH, sizeRef, 0.910, 0.680, 'portal_shop_fw.png', 0.38)));
                            sprites.add(MapEntry(0.877, _plazaPortal(worldW, worldH, sizeRef, 0.510, 0.877, 'portal_quest_fw.png', 0.26)));
                          }
                          // 🧍 내 캐릭터 (탭 통과)
                        ...
                        _standNpc(worldW, worldH, sizeRef, widget.isSea ? 0.585 : 0.507,
                            ...
                            scale: 0.9),
                        _standNpc(worldW, worldH, sizeRef, widget.isSea ? 0.834 : 0.680,
  ...
  Widget _araNpc(double worldW, double worldH, double sizeH) {
    ...
    final figW = figH * 0.6;
    final cx = widget.isSea ? 0.281 : 0.510;
