...
class _PlazaScreenState extends State<PlazaScreen> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _walkCtrl = AnimationController(vsync: this, duration: const Duration(milliseconds: 230)); // 이동속도(240px/s)에 맞춘 걷기주기(미끄러짐 방지)
                            ...
                            child: IgnorePointer(
                              child: AnimatedBuilder(
                                ...
                                builder: (context, _) {
                                  ...
                                  final bob = _walking ? math.sin(phase).abs() * 3.5 : 0.0; // 걸음 상하 바운스(미끄러짐 완화)
